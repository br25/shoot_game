...
shot_fx = pygame.mixer.Sound('assets/sounds/gunshot.mp3')
...
restart_img = pygame.image.load('assets/images/restart_btn.png').convert_alpha()
#background
...
for x in range(TILE_TYPES):
	img = pygame.image.load(f'assets/images/Tile/{x}.png')
...
with open(f'utils/level{level}_data.csv', newline='') as csvfile:
